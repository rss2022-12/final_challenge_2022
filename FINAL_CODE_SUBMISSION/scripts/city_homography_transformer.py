...
PTS_IMAGE_PLANE = [[672.0 - 648.0, 376.0 - 15.0],
                   [672.0 - 11.0, 376.0 - 19.0],
                   [672.0 - 649.0, 376.0 - 133.0],
                   [672.0 - 45.0, 376.0 - 124.0]] # dummy points
######################################################
...
######################################################
## DUMMY POINTS -- ENTER YOUR MEASUREMENTS HERE
PTS_GROUND_PLANE = [[8.5, 6.0],
                    [9.25, -10.25],
                    [36.0, 32.0],
                    [32.75, -26.25]] # dummy points
######################################################
...
class HomographyTransformer:
    def __init__(self):
        ...
        # self.zed_pt_sub = rospy.Subscriber("/zed/zed_node/rgb/image_rect_color_mouse_left", Point, self.testing_marker)
    ...
    def testing_marker(self, point):
        x, y = self.transformUvToXy(point.x, point.y)
