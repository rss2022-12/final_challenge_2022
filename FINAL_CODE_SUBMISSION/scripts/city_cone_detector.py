...
def cd_color_segmentation_callback(img):
    ...
    img = img[img_slice:]
    light_orange = (10, 180, 190) # (0, 180, 50) # JOHNSON: (10, 180, 190)
    dark_orange = (23, 255, 255) # (15, 255, 255) # JOHNSON: (23, 255, 255)
    #src=cv2.imread(img)
    ...
    pub = rospy.Publisher("relative_cone_px", ConeLocationPixel, queue_size=1)
	...
	pixel_location.u = x + w//2 # w//4
    else:
        pixel_location.u = x + w//2 # w//4
    pixel_location.v=y + h//2 + img_slice # 3h/4
